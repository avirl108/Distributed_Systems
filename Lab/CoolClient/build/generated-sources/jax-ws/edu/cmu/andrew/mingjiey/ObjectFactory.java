 ...
 * generated in the edu.cmu.andrew.mingjiey package. 
...
public class ObjectFactory {
    ...
    private final static QName _FooResponse_QNAME = new QName("http://mingjiey.andrew.cmu.edu/", "fooResponse");
    private final static QName _Foo_QNAME = new QName("http://mingjiey.andrew.cmu.edu/", "foo");
    private final static QName _PurchaseResponse_QNAME = new QName("http://mingjiey.andrew.cmu.edu/", "purchaseResponse");
    private final static QName _Purchase_QNAME = new QName("http://mingjiey.andrew.cmu.edu/", "purchase");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: edu.cmu.andrew.mingjiey
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mingjiey.andrew.cmu.edu/", name = "fooResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mingjiey.andrew.cmu.edu/", name = "foo")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mingjiey.andrew.cmu.edu/", name = "purchaseResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mingjiey.andrew.cmu.edu/", name = "purchase")
