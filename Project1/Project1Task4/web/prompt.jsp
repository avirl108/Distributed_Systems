...
<html>
    ...
    <body>
        <h1>Search the</h1>
        <h1><a href ="http://nationalzoo.si.edu/scbi/migratorybirds/featured_photo/ ">Smithsonian Migratory Bird Center Bird Photo Gallery</a></h1>
        <h1>for images of migratory birds.</h1>
        <!--the form is from nationalzoo website-->
