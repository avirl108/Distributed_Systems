...
<html>
    ...
    <body>
        <h2 align = "center">Here is a picture of a</h2>
        <h2 align = "center"> <%= request.getAttribute("pictureTag")%></h2>
        <h2 align = "center">from the <a href ="http://nationalzoo.si.edu/scbi/migratorybirds/featured_photo/ ">Smithsonian Migratory Bird Center Bird Photo Gallery</a></h2>
        <div align = "center">           
            <img src="<%= request.getAttribute("pictureURL")%>"><br>
            <h4 align = "center"> ©<%= request.getAttribute("photographerTag")%></h4> 
            <form action="searchPictures" method="GET">
                <div class="form-group">  
                <label for="tags" class="sr-only">Select another bird to display:</label>
