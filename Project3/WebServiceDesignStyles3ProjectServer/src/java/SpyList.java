/**
 * SpyList to store spy in a treemap and have methods to print out info in xml or plain text format
 * @author JY
 */
...
public class SpyList {
    ...
    public String toString() {
        StringBuffer representation = new StringBuffer(); Collection c = getList();
    ...
    public String toXML() {
        StringBuffer xml = new StringBuffer(); xml.append("<spylist>\n");
